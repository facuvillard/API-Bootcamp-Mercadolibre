...
@Configuration
@EnableJpaRepositories(basePackages = {"com.mercadolibre.facundo_villard.repositories"})
...
//                .driverClassName(driver)
    ...
    @Bean
    @Qualifier("datasource")
    @Profile("integration_test") /////////////////// solo para integration_test
    public DataSource getDataSourceTest() {
        return DataSourceBuilder.create()
//                .url("jdbc:h2:mem:kidbtest;MODE=MySQL")
